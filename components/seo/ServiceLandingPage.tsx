...
export function ServiceLandingPage({ config: cfg }: { config: ServiceLandingConfig }) {
  ...
  return (
    <>
      ...
      <section
        aria-labelledby="service-landing-cta-heading"
      ...
      >
        ...
        <Container>
          <div className="relative z-10 text-center">
            ...
            <h2
              id="service-landing-cta-heading"
            ...
            <p className="mx-auto mb-8 max-w-[600px] text-base leading-relaxed text-corematrix-textSecondary">
              Share goals, timeline, and constraints — we&apos;ll reply with a practical technical
              angle and suggested next steps.
            </p>

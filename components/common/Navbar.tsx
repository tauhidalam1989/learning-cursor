        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" aria-label="Go to homepage" className="flex items-center">
              <Image src="/images/logo.png" alt="Corematrix logo" width={180} height={40} priority />
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex lg:items-center lg:gap-10" aria-label="Main navigation">
            <ul className="flex items-center gap-6" role="list">
              {navLinks.map(({ label, href }) => {
                ...
                <Link
                  href={href}
                  className={
                    `inline-flex items-center gap-2 px-3 py-2 text-sm font-medium uppercase tracking-wider transition-all ` +
                    (isActive
                      ? 'text-[#149253]'
            ...
            <div>
              <Link
                href={navCta.href}
                className="ml-6 inline-flex items-center justify-center rounded-md border-2 border-[#149253] px-5 py-2 text-sm font-semibold text-white hover:bg-[#149253]/6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#149253] focus-visible:ring-offset-2"
              >
                {navCta.label}
              </Link>
            </div>
